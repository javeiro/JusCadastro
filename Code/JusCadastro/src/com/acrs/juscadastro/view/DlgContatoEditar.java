 ...
 * @author acrs
 */
public final class DlgContatoEditar extends javax.swing.JDialog implements IPnlContato {
     ...
     * @param modal
     */
    public DlgContatoEditar(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public DlgContatoEditar(java.awt.Dialog parent, boolean modal, Integer idAgendaTelefonica) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DlgContatoEditar dialog = new DlgContatoEditar(new javax.swing.JDialog(), true, 101);
