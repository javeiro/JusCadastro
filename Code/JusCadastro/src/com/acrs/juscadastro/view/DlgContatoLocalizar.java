 ...
 * @author acrs
 */
public class DlgContatoLocalizar extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public DlgContatoLocalizar(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
        agruparOpcoes();
    ...
    private void initComponents() {
        ...
        setTitle("Localizar Agenda Telefônica");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DlgContatoLocalizar dialog = new DlgContatoLocalizar(new javax.swing.JDialog(), true);
